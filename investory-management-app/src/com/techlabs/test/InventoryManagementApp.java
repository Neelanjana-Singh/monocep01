...
import com.techlabs.Interface.TransactionType;
            ...
            try {
                switch (choice) {
                    case 1:
                        ...
                        System.out.println("Supplier added successfully. Supplier ID:"+ supplier.getSupplierId());
                        break;
                    case 2:
                        ...
                        if (existingSupplier != null) {
                            ...
                            System.out.println("Supplier information updated successfully. Supplier ID: " + supplierId);
                        } else {
